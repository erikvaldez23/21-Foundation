...
import CheckoutForm from "../sub-pages/give/CheckoutForm"; // Adjust path if needed
            ...
            {status === "success" ? (
              ...
              >
                ...
                <Box sx={{
                  ...
                  {/* Custom Amount as a fake button that triggers focus or just a text field below?
                      Let's put the text field below as a full width option.
                  */}
                </Box>
